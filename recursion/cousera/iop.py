...
EMPLOYEE_AVAILABILITY_PATH = QUADMIN_FORMAT_PATH + 'employee_availability.parquet' # noqa E501
...
def load_employee_availability():
    ...
    weekly_capacity = employee_availability.loc[:, (slice(None), 'Weekly Capacity')]  # noqa E501
